...
export const NOTIFICATION_EVENT_KEYS = {
  ...
  // Journey / start-OTP (helper Start Journey → customer)
  HELPER_ON_THE_WAY: 'HELPER_ON_THE_WAY',

  // Completion events
  TASK_COMPLETED: 'TASK_COMPLETED',
  TASK_COMPLETED_TASKER: 'TASK_COMPLETED_TASKER',
  REVIEW_REQUEST: 'REVIEW_REQUEST',

  // Cancellation (other party notified)
  TASK_CANCELLED_CUSTOMER: 'TASK_CANCELLED_CUSTOMER',
  TASK_CANCELLED_HELPER: 'TASK_CANCELLED_HELPER',
} as const;
...
export const EVENT_KEY_TO_CATEGORY: Record<NotificationEventKey, NotificationCategory> = {
  ...
  [NOTIFICATION_EVENT_KEYS.HELPER_ON_THE_WAY]: 'taskUpdates',
  [NOTIFICATION_EVENT_KEYS.TASK_COMPLETED]: 'taskUpdates',
  [NOTIFICATION_EVENT_KEYS.TASK_COMPLETED_TASKER]: 'taskUpdates',
  [NOTIFICATION_EVENT_KEYS.REVIEW_REQUEST]: 'taskUpdates',
  [NOTIFICATION_EVENT_KEYS.TASK_CANCELLED_CUSTOMER]: 'taskUpdates',
  [NOTIFICATION_EVENT_KEYS.TASK_CANCELLED_HELPER]: 'taskUpdates',
};
