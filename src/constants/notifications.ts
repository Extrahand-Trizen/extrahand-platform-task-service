...
export const NOTIFICATION_EVENT_KEYS = {
  ...
  // Global budget revision events
  TASK_BUDGET_REVISED: 'TASK_BUDGET_REVISED',
  BUDGET_REVISION_RESPONSE: 'BUDGET_REVISION_RESPONSE',
  ...
  // Book Now / Supply Layer
  BOOK_NOW_PAYMENT_CONFIRMED: 'BOOK_NOW_PAYMENT_CONFIRMED',
  BOOK_NOW_OFFER_RECEIVED: 'BOOK_NOW_OFFER_RECEIVED',
  BOOK_NOW_OFFER_EXPIRING: 'BOOK_NOW_OFFER_EXPIRING',
  BOOK_NOW_PARTNER_ASSIGNED: 'BOOK_NOW_PARTNER_ASSIGNED',
  BOOK_NOW_PARTNER_ARRIVED: 'BOOK_NOW_PARTNER_ARRIVED',
  BOOK_NOW_DISPATCH_FAILED: 'BOOK_NOW_DISPATCH_FAILED',
  SUPPLY_APPLICATION_APPROVED: 'SUPPLY_APPLICATION_APPROVED',
  SUPPLY_APPLICATION_REJECTED: 'SUPPLY_APPLICATION_REJECTED',
} as const;
...
export const EVENT_KEY_TO_CATEGORY: Record<NotificationEventKey, NotificationCategory> = {
  ...
  [NOTIFICATION_EVENT_KEYS.TASK_NEARBY]: 'recommendedTaskAlerts',
  ...
  [NOTIFICATION_EVENT_KEYS.TASK_BUDGET_REVISED]: 'taskUpdates',
  [NOTIFICATION_EVENT_KEYS.BUDGET_REVISION_RESPONSE]: 'taskUpdates',
  [NOTIFICATION_EVENT_KEYS.NEGOTIATION_COUNTER]: 'taskUpdates',
  [NOTIFICATION_EVENT_KEYS.NEGOTIATION_ACCEPTED]: 'taskUpdates',
  [NOTIFICATION_EVENT_KEYS.NEGOTIATION_REJECTED]: 'taskUpdates',
  ...
  [NOTIFICATION_EVENT_KEYS.BOOK_NOW_PAYMENT_CONFIRMED]: 'payments',
  [NOTIFICATION_EVENT_KEYS.BOOK_NOW_OFFER_RECEIVED]: 'taskUpdates',
  [NOTIFICATION_EVENT_KEYS.BOOK_NOW_OFFER_EXPIRING]: 'taskUpdates',
  [NOTIFICATION_EVENT_KEYS.BOOK_NOW_PARTNER_ASSIGNED]: 'taskUpdates',
  [NOTIFICATION_EVENT_KEYS.BOOK_NOW_PARTNER_ARRIVED]: 'taskUpdates',
  [NOTIFICATION_EVENT_KEYS.BOOK_NOW_DISPATCH_FAILED]: 'taskUpdates',
  [NOTIFICATION_EVENT_KEYS.SUPPLY_APPLICATION_APPROVED]: 'taskUpdates',
  [NOTIFICATION_EVENT_KEYS.SUPPLY_APPLICATION_REJECTED]: 'taskUpdates',
};
