...
// POST /api/v1/tasks/:id/execution-phase/on-the-way - Helper started journey
router.post(
  "/:id/execution-phase/on-the-way",
  serviceAuthMiddleware,
  authMiddleware,
  asyncHandler(TaskController.markExecutionOnTheWay)
);

// POST /api/v1/tasks/:id/execution-phase/arrived - Helper arrived at location
router.post(
  "/:id/execution-phase/arrived",
  serviceAuthMiddleware,
  authMiddleware,
